...
export default function CourseViewPage() {
  ...
  const handleDelete = async (courseNumber: string) => {
    try {
      ...
      const indexToRemove = existingCourses.courses.findIndex(
  ...
  return (
    <div>
      ...
      <LogoutButton type="button" onClick={handleHomeClick}>
        Logout
      </LogoutButton>
      <br></br>
      <NewCourseButton type="button" onClick={handleNewCourseClick}>
        Add a New Course
      </NewCourseButton>
      <br></br>
    </div>
