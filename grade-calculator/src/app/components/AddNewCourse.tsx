...
export default function AddNewCourse() {
  ...
  const submitHandler = async (event: FormEvent) => {
    ...
    if (!image.startsWith("https://images.unsplash.com/")) {
      setErrorMessage(
        "The image URL must start with https://images.unsplash.com/."
      );
      return;
    }
    ...
    <div>
      <section className={style.bg}>
        <div className={style.Xbutton}>
          <ExitNewCourseButton type="button" onClick={handleCourseViewClick}>
            ⓧ
          </ExitNewCourseButton>
        </div>
        ...
        <form onSubmit={submitHandler} className={style.form}>
          ...
          <div className={style.submitButton}>
            <SubmitNewCourseButton type="button" onClick={submitHandler}>
              Submit
            </SubmitNewCourseButton>
          </div>
        </form>
      </section>
    </div>
